...
::meta_units::make_unit! {
    Kilometers : f64,
    base = Meters,
    from_base = |x: Meters| <Kilometers as ::meta_units::Unit>::new(::meta_units::Unit::get(&x) / 1e3),
    into_base = |x: Kilometers| <Meters as ::meta_units::Unit>::new(::meta_units::Unit::get(&x) * 1e3),
}
::meta_units::make_unit! {
    Megameters : f64,
    base = Meters,
    from_base = |x: Meters| <Megameters as ::meta_units::Unit>::new(::meta_units::Unit::get(&x) / 1e6),
    into_base = |x: Megameters| <Meters as ::meta_units::Unit>::new(::meta_units::Unit::get(&x) * 1e6),
}
...
fn test_basic_1() {
    ...
    ::std::println!("{} {}", ::meta_units::Unit::get(&x), ::meta_units::Unit::get(&y));

    let x = <Meters as ::meta_units::Unit>::new(10.0);
    let y = x;
    ::std::println!("{} {}", ::meta_units::Unit::get(&x), ::meta_units::Unit::get(&y));

    ::core::assert_eq!(::std::format!("{x}"), ::std::format!("{}", ::meta_units::Unit::get(&x)));
    ::core::assert_eq!(::std::format!("{x:?}"), ::std::format!("{:?}", ::meta_units::Unit::get(&x)));
...
fn test_conversion_1() {
    ...
    ::core::assert_eq!(*::meta_units::Unit::get(&x), 2000.0);
    ::core::assert_eq!(*::meta_units::Unit::get(&y), 2.0);
    ::core::assert_eq!(*::meta_units::Unit::get(&z), 2000.0);
